      ...
      <el-col>
        ...
        >
          ...
          <el-submenu index="4">
            ...
            <el-menu-item-group>
              <el-menu-item index="4-3" @click="goPage('product_category')">产品种类</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="4-4" @click="goPage('order_manager')">订单管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="4-5" @click="goPage('sale_manager')">售后管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
          ...
          <el-submenu index="5">
            ...
            <el-menu-item-group>
              <el-menu-item index="5-2" @click="goPage('provider')">品牌生产商</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="4-3" @click="goPage('product_category')">产品种类</el-menu-item>
            </el-menu-item-group>
