      ...
      <el-col>
        ...
        >
          ...
          <el-submenu index="4">
            ...
            <el-menu-item-group>
              <el-menu-item index="3-2" @click="goPage('provider')">品牌生产商</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="3-3" @click="goPage('product_category')">产品种类</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="3-4" @click="goPage('order_manager')">订单管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="3-5" @click="goPage('sale_manager')">售后管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="3-6" @click="goPage('opinion')">意见反馈</el-menu-item>
            </el-menu-item-group>
