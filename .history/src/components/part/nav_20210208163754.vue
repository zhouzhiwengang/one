      ...
      <el-col>
        ...
        >
          ...
          <el-submenu index="6">
            ...
            <el-menu-item-group>
              <el-menu-item index="6-1" @click="goPage('product-list')">广告管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="6-2" @click="goPage('product-put-on')">优惠卷管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="6-3" @click="goPage('product-comment')">专题管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="6-4" @click="goPage('product-comment')">专题管理</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="6-5" @click="goPage('product-comment')">专题管理</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
